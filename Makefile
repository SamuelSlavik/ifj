...
########################### PARSER #################################
./bin/test-parser: ./bin/parser.o ./bin/scanner.o ./bin/dynamic_buffer.o ./bin/error.o ./bin/expression_parser.o ./bin/stack.o ./bin/dynamic_buffer.o ./bin/dll_instruction_list.o ./bin/htab.o ./bin/symtable.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
