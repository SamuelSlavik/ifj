...
########################### PARSER #################################
./bin/test-parser: ./bin/parser.o ./bin/scanner.o ./bin/dynamic_buffer.o ./bin/error.o ./bin/expression_parser.o ./bin/stack.o ./bin/dynamic_buffer.o ./bin/dll_instruction_list.o ./bin/htab.o ./bin/symtable.o ./bin/expression_codegen.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
...
./bin/test-expression_parser: ./bin/test-expression_parser.o ./bin/stack.o ./bin/scanner.o ./bin/error.o ./bin/dynamic_buffer.o ./bin/htab.o ./bin/symtable.o ./bin/dll_instruction_list.o ./bin/htab.o ./bin/symtable.o ./bin/expression_codegen.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
